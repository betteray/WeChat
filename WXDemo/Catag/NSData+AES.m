...
static int aes_cbc_encrypt(const unsigned char* pKey, unsigned int uiKeyLen
...
static int aes_cbc_decrypt(const unsigned char* pKey, unsigned int uiKeyLen
                    , const unsigned char* pInput, unsigned int uiInputLen
                    , unsigned char** ppOutput, unsigned int* pOutputLen)
{
...
static int aes_ecb_encrypt(const unsigned char* pKey, unsigned int uiKeyLen
...
static int aes_ecb_decrypt(const unsigned char* pKey, unsigned int uiKeyLen
                    , const unsigned char* pInput, unsigned int uiInputLen, int bFinal
                    , unsigned char** ppOutput, unsigned int* pOutputLen)
{
    unsigned char keyBuf[AES_KEY_LEN] = {0};
