...
- (instancetype)init
{
    ...
    if (self)
    {
        ...
        NSData *clientSpamInfoData = [NSData dataWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"1591885083-st-34847" ofType:@"bin"]];
        ClientSpamInfo *clientSpamInfo = [ClientSpamInfo parseFromData:clientSpamInfoData error:nil];

        NSData *fpData = [NSData dataWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"1591885006-fpdevices-2236" ofType:@"bin"]];
        FPDevice *fp = [FPDevice parseFromData:fpData error:nil];

        NSData *manualAuthData = [NSData dataWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"1591885044611_cgi-bin_micromsg-bin_secmanualauth" ofType:@"bin"]];
...
//        NSData *onlineDeviceJsonData = [NSData dataWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"device7012" ofType:@"txt"]];
...
//        WCDevice *onlineDevice = [WCDevice deviceFromWNJson:onlineDeviceJson fp:fp];
