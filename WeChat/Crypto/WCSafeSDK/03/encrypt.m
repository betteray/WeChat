...
//    UInt8 inbuff[16] = {0xAB, 0x9D, 0x6C, 0x9C, 0xAE, 0x63, 0xFD, 0x25, 0x2A, 0x7D, 0xE6, 0xD4, 0xB8, 0xEE, 0xFD, 0xCA};
//    getsecvaluefinnal(inbuff, saetablefinal); // => 46 ee 00 52 9c f7 1e a6 86 a1 4f d7 bd 86 03 3b
